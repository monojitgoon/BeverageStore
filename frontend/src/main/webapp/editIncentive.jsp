...
<body>
	...
	<div class="container">
		...
		<%
			Incentive inc = (Incentive) request.getAttribute("incentive");
		%>
		<form role="form" action="/frontend/incentives" method="post">
			<input type="hidden" name="incentive_id" value="<%=inc.getId()%>">

			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">Incentive Name</span> <input
						name="incentive_name" type="text" class="form-control"
						value="<%=inc.getName()%>">
				</div>
			</div>
			<div class="form-group">
				<span class="input-group-addon">Type of incentive</span> <select
					class="form-control" id="editSelect" required="true"
					name="<%=inc.getType()%>" disabled>
