...
<div class="container" style="margin-bottom: 5cm;">
		...
		<table class="table table-striped">
			...
			<tbody>
				<%
					List<Incentive> beverages = (List<Incentive>) request.getAttribute("incentivesList");
				...
				<tr>
					...
					<td class="col-md-4">
						<div class="btn-group" role="group">
							<a href="/frontend/incentives?incentive_id=<%=inc.getId()%>"
								class="btn btn-primary">Edit Incentive</a> <a
								id="<%=inc.getId()%>" href="" class="delete btn btn-danger">Delete
								Incentive</a> 
						</div>
					</td>
				</tr>
	...
	<script>
		$(document).ready(function() {
			$(".delete").click(function() {
				...
				$.ajax({
					url : '/frontend/incentives?incentive_id=' + event.target.id,
					type : 'DELETE',
